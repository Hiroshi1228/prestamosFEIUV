 ...
 *       &lt;sequence&gt;
 *         &lt;element name="horario" maxOccurs="unbounded"&gt;
 *           &lt;complexType&gt;
 *             &lt;complexContent&gt;
 *               &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType"&gt;
 *                 &lt;sequence&gt;
...
@XmlRootElement(name = "VerCubiculoResponse")
public class VerCubiculoResponse {

    @XmlElement(required = true)
    protected List<VerCubiculoResponse.Horario> horario;
     ...
     * {@link VerCubiculoResponse.Horario }
     * 
     * 
     */
    public List<VerCubiculoResponse.Horario> getHorario() {
        if (horario == null) {
            horario = new ArrayList<VerCubiculoResponse.Horario>();
        }
        return this.horario;
    }
